...
func (u *UserApi) Init() {
	...
	groupRouter.Post("/register",Cors, u.register)
	groupRouter.Post("/login", Cors,u.login)
	groupRouter.Put("/logout", Cors,loginMeddle, u.logout)
	groupRouter.Post("/password/reset",Cors, loginMeddle, u.reset)
	groupRouter.Get("/message",Cors, loginMeddle, u.message)
	groupRouter.Post("/message/edit",Cors, loginMeddle, u.editMessage)
	groupRouter.Get("/commend/video",Cors, loginMeddle, u.getCommendVideo)
	groupRouter.Get("/commend/video/default",Cors, u.getCommendVideoDefault)
	groupRouter.Get("/history/video",Cors, loginMeddle, u.getHistoryVideo)
